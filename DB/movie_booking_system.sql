...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 29, 2021 at 02:50 AM
...
(1, 'Lion King', 1, 1, 1, 'Ahmer', 'Maryam Muccadam', 'asnasjnaknsas', 'https://www.youtube.com/watch?v=qoq8B8ThgEM', '0000-00-00', 1, 'uploads/france-in-pictures-beautiful-places-to-photograph-eiffel-tower - Copy - Copy.jpg');
...
(1, 'good movie', '2021-09-22', 1, 'ahmer123');
...
--
ALTER TABLE `hall`
  MODIFY `hall_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `movie`
  MODIFY `movie_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `movie_inslot`
--
ALTER TABLE `movie_inslot`
  MODIFY `m_inslot_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `slot`
  MODIFY `slot_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
