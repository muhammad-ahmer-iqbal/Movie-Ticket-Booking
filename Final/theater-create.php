...
if(isset($_POST['submit']))
    {
        ...
        // if everything is ok, try to upload file
            ...
            if (move_uploaded_file($_FILES["theater_image"]["tmp_name"], $target_file)) {
                $query = "INSERT INTO theater (theater_name, theater_place, theater_owner, theater_contactNo, theater_email, theater_address, theater_image) VALUES ('$name', '$place', '$owner', '$contact', '$email', '$address', '$target_file')";

                $ins = mysqli_query($conn, $query);
                mysqli_close($conn);
                header("location:theater-index.php?addMessage=Added Successfully");
