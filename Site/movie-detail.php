    ...
    <div class="movie-center-content">
        <div class="container">
            ...
            <div class="row my-4">
                <div class="col-lg-6">
                    <div class="movie-img">
                        <img src="../Dashboard/<?php echo $poster;?>" class="img-fluid" width="100%" alt="Movie">
                    </div>
                </div>
                                                ...
                                                echo    '<div class="col-lg-6">
                                                            <div class="content">
                                                                <a href="booking-form.php">
                                                                    ...
                                                                    <img class="content-image" src="../Dashboard/' . $row1['theater_image'] . '">
            ...
            <?php
                if(isset($_SESSION['User']))
                {
                    ...
                    include '..\Assets\review-rating.php';
            ?>
        </div>
