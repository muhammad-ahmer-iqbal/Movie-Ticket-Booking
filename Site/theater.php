...
<body>
    ...
    <?php session_start(); include '..\Assets\header.html'; ?>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../Media/atrium-slide-1.jpg" class="d-block" alt="Moive-Img">
                </div>
                <div class="carousel-item">
                    <img src="../Media/centaurus-slide-2.jpg" class="d-block" alt="Moive-Img">
                </div>
                <div class="carousel-item">
                    <img src="../Media/atrium-slide-3.jpg" class="d-block" alt="Moive-Img">
                </div>
                <div class="carousel-item">
                    <img src="../Media/centaurus-slide-4.jpg" class="d-block" alt="Moive-Img">
                </div>
            </div>
        </div>
    </div>
                ...
                echo    '<div class="col-md-3 mb-5">
                                <div class="content">
                                    <a href="theater-detail.php?theaterId=' . $row['theater_id'] . '">
                                        ...
                                        <img class="content-image" src="../Dashboard/' . $row['theater_image'] . '" alt="theater img">
