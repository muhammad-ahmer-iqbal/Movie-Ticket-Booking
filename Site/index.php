...
<body>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="..\Media/slide-1.png" class="d-block" alt="Moive-Img">
                </div>
                <div class="carousel-item">
                    <img src="..\Media/GRM_banner-f9.jpeg" class="d-block" alt="Moive-Img">
                </div>
                <div class="carousel-item">
                    <img src="..\Media/army-of-the-dead-gd.jpg" class="d-block" alt="Moive-Img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mb-5">
        ...
        <div class="row mb-5">
            ...
            $query1 = "SELECT movie.movie_id, movie.movie_poster, movie.movie_releaseDate FROM movie JOIN movie_inslot ON movie_inslot.m_inslot_movieName = movie.movie_id LIMIT 4";
                ...
                echo    '<div class="col-md-3 mb-5">
                                <div class="content">
                                    <a href="movie-detail.php?movieId=' . $row1['movie_id'] . '">
                                        ...
                                        <img class="content-image" src="../Dashboard/' . $row1['movie_poster'] . '" alt="movie img">
                ...
                echo    '<div class="col-md-3 mb-5">
                                <div class="content">
                                    <a href="movie-detail.php?movieId=' . $row2['movie_id'] . '">
                                        <div class="content-overlay"></div>
                                        <img class="content-image" src="../Dashboard/' . $row2['movie_poster'] . '" alt="movie img">
                                        <div class="content-details fadeIn-bottom">
                                            <h6>Release Date</h6>
                                            <h5>Coming Soon</h5>
                                            <br>
                ...
                echo    '<div class="col-md-3 mb-5">
                                <div class="content">
                                    <a href="theater-detail.php?theaterId=' . $row3['theater_id'] . '">
                                        <div class="content-overlay"></div>
                                        <img class="content-image" src="../Dashboard/' . $row3['theater_image'] . '" alt="theater img">
                                        <div class="content-details fadeIn-bottom">
