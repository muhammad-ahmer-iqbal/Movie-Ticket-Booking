...
<head>
    ...
    <title>The Baby Boss - Ticket.com</title>
            ...
            <div class="row my-4">
                <div class="col-lg-7">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="movie-img">
                                <img src="assets\card-4.jpg" class="img-fluid" width="100%" alt="Movie">
                            </div>
                        </div>
                                ...
                                <div class="detail-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <h6>: On Show</h6>
                                            <h6>:
                                                <a href="https://www.imdb.com/title/tt3874544/" target="_blank">
                                                    <span class="rate-text">IMDB</span>
                                                    <span class="rate-no">6.3</span>
                                                </a>
                                            </h6>
                                    ...
                                    <div class="story-line mt-3">
                                        <h5>Storyline</h5>
                                        <p>Long ago up North on the Island of Berk, the young Viking,
                            ...
                            <div class="col-lg-4">
                                <a href="Tom-and-jerry-movie.php">
                                    ...
                                    <div class="movie-related-card">
                                        ...
                                        <p class="my-3 fw-bold text-center">Tom And Jerry</p>
                                    </div>
                ...
                <div class="col-lg-5">
                    ...
                    <a href="Tom-and-jerry-movie.php">
                        ...
                        <div class="card mb-3" style="max-width: 540px;">
                            <div class="row g-0">
                                <div class="col-lg-4">
                                    <img src="./assets/card-1.jpg" width="100%" class="img-fluid rounded-start" alt="Card">
                                </div>
                                <div class="col-lg-8 align-self-center">
                                    <div class="card-body">
                                        <h5 class="card-title text-danger">Tom And Jerry</h5>
                                        <p class="card-text">Adaptation of the classic Hanna-Barbera property,
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-danger" id="exampleModalLabel">The Baby Boss</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/k397HRbTtWI" 
