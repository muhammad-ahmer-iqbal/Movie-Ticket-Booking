...
<head>
    ...
    <title>How To Train Your Dragon - Ticket.com</title>
            ...
            <div class="row my-4">
                <div class="col-lg-7">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="movie-img">
                                <img src="assets\card-2.jpg" class="img-fluid" width="100%" alt="Movie">
                            </div>
                        </div>
                                ...
                                <div class="detail-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <h6>: On Show</h6>
                                            <h6>:
                                                <a href="https://www.imdb.com/title/tt0892769/" target="_blank">
                                                    <span class="rate-text">IMDB</span>
                                                    <span class="rate-no">8.1</span>
                                                </a>
                                            </h6>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-danger" id="exampleModalLabel">How To Train Dragon</h5>
