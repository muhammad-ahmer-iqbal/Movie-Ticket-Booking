    ...
    <div class="movie-center-content">
        <div class="container">
            ...
            <div class="movie-heading my-4">
                <h2>JAWANI PHIR NAHI ANI 2</h2>
            </div>
            <div class="row my-4">
                <div class="col-lg-6">
                    <div class="movie-img">
                        <img src="assets\card-5.jpg" class="img-fluid" width="100%" alt="Movie">
                    </div>
                </div>
                        ...
                        <div class="detail-heading">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <h6>: On Show</h6>
                                    <h6>:
                                        <a href="https://www.imdb.com/title/tt7816386/?ref_=fn_al_tt_1" target="_blank">
                                            <span class="rate-text">IMDB</span>
                                            <span class="rate-no">7.4</span>
                                        </a>
                                    </h6>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header text-center">
                    <h5 class="modal-title text-danger" id="exampleModalLabel">JAWANI PHIR NAHI ANI 2</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/TUM6liPArUE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
